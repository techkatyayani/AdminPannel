...
class _BannerScreenState extends State<BannerScreen> {
  ...
  Future<void> updateImageUrlInFirestore(String imageName, String imageUrl) async {
    try {
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text('Hindi Slide Banner', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: width * 0.01),),
                    ),
                    SizedBox(height: 20,),
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => _pickImageAndUpdate('best selling hindi.jpg'),
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: Colors.black,
                        ...
                        GestureDetector(
                          onTap: () => _pickImageAndUpdate('agri advisor hindi.jpg'),
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: Colors.black,
                        ...
                        GestureDetector(
                          onTap: () => _pickImageAndUpdate('crop calender hindi.jpg'),
                          child: Container(
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: Colors.black,
