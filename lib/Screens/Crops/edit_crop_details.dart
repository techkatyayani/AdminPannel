        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Consumer<CropProvider>(builder: (context, provider, child) {
                return Expanded(
                  child: ListView.builder(
                      itemCount: provider.keys.length,
                      itemBuilder: (context, index) {
                        TextEditingController keyController =
                            provider.keys.entries.toList()[index].value;
                        TextEditingController valueController =
                            provider.values.entries.toList()[index].value;
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: _customTextField(
                                    hintText: 'Key', controller: keyController),
                              ),
                              const SizedBox(width: 20),
                              SizedBox(
  ...
  Widget _customTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
          hintText: hintText,
          hintStyle: const TextStyle(fontSize: 16, color: boxColor),
          filled: true,
